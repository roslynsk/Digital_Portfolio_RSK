...
import prototyping1Img from "../assets/Prototyping2Img.jpg";
import prototyping2Img from "../assets/prototyping1Img.jpg";
import prototyping3Img from "../assets/Prototyping3Img.jpg";
import prototyping4Img from "../assets/prototyping4Img.jpg";
...
const projectData = [
  ...
  },
  {
    ...
    title: "HaptiX",
    subtitle:
      "A haptic feedback suite for immersive simulation gaming",
    coDesigners:
      "Padraig Mannix, Moya Sheehan and Emily McCormack",
    videoUrl: undefined,
    intro:
      "HaptiX was developed as part of Real World Studio, a module in which student teams collaborate with industry clients to solve real design challenges. Our group worked with Logitech to explore how simulation couch gaming could be made more immersive and accessible.",
    images: [
      haptixResearchImg,
      haptixIdeationImg,
      haptixScamperImg,
  ...
  // 👇 NEW PROJECT ADDED
  {
    ...
    title: "Penta Glow",
    subtitle:
      "A laser-cut wooden lamp exploring light, form and digital fabrication",
    videoUrl: undefined,
    intro:
      "Penta Glow is a fabrication project focused on learning laser cutting and assembly techniques. The lamp was designed and laser-cut from wood, with 3D-printed brackets used to assemble the geometric structure. The project explores form, light diffusion and materiality through hands-on prototyping and digital fabrication tools.",
    images: [
      prototyping1Img,
      prototyping2Img,
      prototyping3Img,
    ...
    sections: [
      {
        heading: "Concept",
        text:
          "The project began as an exploration of how light interacts with geometric wooden forms. I wanted to create a simple but visually striking lamp that could act as a learning exercise in laser cutting and physical assembly.",
      },
      {
        heading: "Fabrication",
        text:
          "The lamp was laser-cut from wood and assembled using custom 3D-printed brackets. This allowed me to experiment with precision fitting and modular construction without relying on adhesives.",
      },
      {
        heading: "Reflection",
        text:
          "This project helped me develop confidence in digital fabrication tools, particularly laser cutting and 3D printing, and improved my understanding of how design decisions affect physical assembly and structural stability.",
      },
    ],
  },
];
    ...
    <div className="project-detail">
      ...
      <div className="project-detail-layout">
        ...
        <div className="project-detail-text">
          ...
          {project.coDesigners && (
            <p className="project-codesigners">
              Co-designers: {project.coDesigners}
            </p>
          )}
